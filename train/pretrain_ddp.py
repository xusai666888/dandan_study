...
def train_epoch(epoch, loader, iters, start_step=0, swanlab=None, total_steps=None, warmup_steps=None, full_save_dir=None):
    ...
    for step, (input_ids, labels) in enumerate(loader, start=start_step + 1):
        ...
        if args.eval_bench == 1 and tokenizer is not None and global_step % args.eval_interval == 0 and is_main_process():
            model.eval()
            c3_path = '/root/autodl-tmp/dandan_study/benchmark/clue_c3_eval_500.jsonl'
            xcopa_path = '/root/autodl-tmp/dandan_study/benchmark/xcopa_zh_merged.jsonl'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/dandan_study/SpongeBobPRO_pretrain_512_final.bin", help="预处理后的.bin文件路径")
    ...
    if args.eval_bench == 1:
        ...
        tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/dandan_study/tokenizer_15k')
